...
SEED_CASES = (
    ...
    VariantSeed("8@night", "2020-12-25 21:00:00", "alias"),
    VariantSeed("5 nights time", "2020-12-30 17:05:55", "relative_time"),
    VariantSeed("12 days prior today", "2020-12-13 17:05:55", "anchor_offset"),
    VariantSeed("12 days earlier today", "2020-12-13 17:05:55", "anchor_offset"),
    VariantSeed("12 days before today", "2020-12-13 17:05:55", "anchor_offset"),
    ...
    VariantSeed("every monday", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("every weekday", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("weekdays", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("on weekdays", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("every weekday at 9am", "2020-12-28 09:00:00", "recurring_schedule"),
    VariantSeed("weekdays at 9am", "2020-12-28 09:00:00", "recurring_schedule"),
    VariantSeed("every weekend", "2020-12-26 17:05:55", "recurring_schedule"),
    VariantSeed("weekends", "2020-12-26 17:05:55", "recurring_schedule"),
    VariantSeed("on weekends", "2020-12-26 17:05:55", "recurring_schedule"),
    VariantSeed("every weekend at noon", "2020-12-26 12:00:00", "recurring_schedule"),
    VariantSeed("every saturday at 8pm", "2020-12-26 20:00:00", "recurring_schedule"),
    VariantSeed("every sunday at 10am", "2020-12-27 10:00:00", "recurring_schedule"),
    VariantSeed("the first friday of each month", "2021-01-01 17:05:55", "recurring_schedule"),
    VariantSeed("the first friday of every month at 9am", "2021-01-01 09:00:00", "recurring_schedule"),
    VariantSeed("the second tuesday of each month", "2021-01-12 17:05:55", "recurring_schedule"),
    VariantSeed("the last sunday of each month", "2020-12-27 17:05:55", "recurring_schedule"),
    VariantSeed("the penultimate wednesday of every month", "2021-01-20 17:05:55", "recurring_schedule"),
    VariantSeed("the first business day of each month", "2021-01-01 17:05:55", "recurring_schedule"),
    VariantSeed("the last business day of each month", "2020-12-31 17:05:55", "recurring_schedule"),
    VariantSeed("the first monday of each month at 9am", "2021-01-04 09:00:00", "recurring_schedule"),
    VariantSeed("every month on the 14th", "2021-01-14 17:05:55", "recurring_schedule"),
    VariantSeed("the 1st of every month", "2021-01-01 17:05:55", "recurring_schedule"),
    VariantSeed("on the 1st of every month at noon", "2021-01-01 12:00:00", "recurring_schedule"),
    VariantSeed("every month on the 31st", "2020-12-31 17:05:55", "recurring_schedule"),
    VariantSeed("every christmas", "2021-12-25 17:05:55", "recurring_schedule"),
    VariantSeed("every christmas at noon", "2021-12-25 12:00:00", "recurring_schedule"),
    VariantSeed("every boxing day", "2021-12-26 17:05:55", "recurring_schedule"),
    VariantSeed("every halloween", "2021-10-31 17:05:55", "recurring_schedule"),
    VariantSeed("every easter", "2021-04-04 17:05:55", "recurring_schedule"),
    VariantSeed("every september 1st", "2021-09-01 17:05:55", "recurring_schedule"),
    VariantSeed("every september 1st at 2pm", "2021-09-01 14:00:00", "recurring_schedule"),
    VariantSeed("every 1st of september", "2021-09-01 17:05:55", "recurring_schedule"),
    VariantSeed("every business day", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("every working day at 9am", "2020-12-28 09:00:00", "recurring_schedule"),
    VariantSeed("the first business day of each quarter", "2021-01-01 17:05:55", "recurring_schedule"),
    VariantSeed("the last business day of every quarter", "2020-12-31 17:05:55", "recurring_schedule"),
    VariantSeed("the last business day of every quarter at 6pm", "2020-12-31 18:00:00", "recurring_schedule"),
    VariantSeed("every other friday", "2021-01-01 17:05:55", "recurring_schedule"),
    VariantSeed("every 2 weeks", "2021-01-08 17:05:55", "recurring_schedule"),
    VariantSeed("every 3 months", "2021-03-25 17:05:55", "recurring_schedule"),
    VariantSeed("the third working day of each month", "2021-01-05 17:05:55", "recurring_schedule"),
    VariantSeed("the last weekend of every month", "2021-01-30 17:05:55", "recurring_schedule"),
    VariantSeed("the first monday of every september", "2021-09-06 17:05:55", "recurring_schedule"),
    VariantSeed("every monday and wednesday", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("every monday and wednesday at 9am", "2020-12-28 09:00:00", "recurring_schedule"),
    VariantSeed("every weekday except friday", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("weekdays except friday at 9am", "2020-12-28 09:00:00", "recurring_schedule"),
    VariantSeed("weeknights", "2020-12-28 21:00:00", "recurring_schedule"),
    VariantSeed("weeknights at 8", "2020-12-28 20:00:00", "recurring_schedule"),
    VariantSeed("every day", "2020-12-26 17:05:55", "recurring_schedule"),
    VariantSeed("every morning", "2020-12-26 09:00:00", "recurring_schedule"),
    VariantSeed("every day from 9 to 5", "2020-12-26 09:00:00", "recurring_schedule"),
    VariantSeed("every weekday from 9 to 5", "2020-12-28 09:00:00", "recurring_schedule"),
    VariantSeed("every first monday in april", "2021-04-05 17:05:55", "recurring_schedule"),
    VariantSeed("the last friday of every year", "2021-12-31 17:05:55", "recurring_schedule"),
    VariantSeed("every 2nd tuesday", "2021-01-12 17:05:55", "recurring_schedule"),
    VariantSeed("every 3 months on the 14th", "2021-03-14 17:05:55", "recurring_schedule"),
    VariantSeed("every christmas eve at 6pm", "2021-12-24 18:00:00", "recurring_schedule"),
    VariantSeed("every monday through june", "2020-12-28 17:05:55", "recurring_schedule"),
    VariantSeed("every friday until next christmas", "2021-01-01 17:05:55", "recurring_schedule"),
    VariantSeed("every friday from next week", "2021-01-01 17:05:55", "recurring_schedule"),
    VariantSeed("recurring fridays from next week", "2021-01-01 17:05:55", "recurring_schedule"),
