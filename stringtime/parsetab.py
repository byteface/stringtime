...
_lr_goto_items = {'date_object':([0,],[1,]),'date_list':([0,],[2,]),'date':([0,2,3,10,],[3,34,39,40,]),'date_past':([0,],[4,]),'in':([0,],[5,]),'adder':([0,],[6,]),'remover':([0,],[7,]),'date_yesterday':([0,],[8,]),'date_2moro':([0,],[9,]),'date_day':([0,],[10,]),'date_end':([0,],[11,]),'date_or':([0,],[12,]),'date_before_yesterday':([0,],[13,]),'date_after_tomorrow':([0,],[14,]),'date_twice':([0,],[15,]),'timestamp':([0,20,],[16,51,]),'timestamp_adpt':([0,],[17,]),}
...
_lr_productions = [
  ...
  ('date_list -> date_before_yesterday','date_list',1,'p_date','__init__.py',449),
  ...
  ('timestamp -> NUMBER COLON NUMBER','timestamp',3,'p_timestamp','__init__.py',473),
  ('timestamp -> NUMBER COLON NUMBER COLON NUMBER','timestamp',5,'p_timestamp','__init__.py',474),
  ('timestamp_adpt -> timestamp AM','timestamp_adpt',2,'p_timestamp_adapter','__init__.py',497),
  ('timestamp_adpt -> timestamp PM','timestamp_adpt',2,'p_timestamp_adapter','__init__.py',498),
  ('timestamp_adpt -> AT timestamp','timestamp_adpt',2,'p_timestamp_adapter','__init__.py',499),
  ('timestamp_adpt -> AT timestamp PM','timestamp_adpt',3,'p_timestamp_adapter','__init__.py',500),
  ('timestamp_adpt -> AT timestamp AM','timestamp_adpt',3,'p_timestamp_adapter','__init__.py',501),
  ...
  ('adder -> PLUS WORD_NUMBER TIME','adder',3,'p_single_date_plus','__init__.py',656),
  ('remover -> MINUS NUMBER TIME','remover',3,'p_single_date_minus','__init__.py',669),
  ('remover -> MINUS WORD_NUMBER TIME','remover',3,'p_single_date_minus','__init__.py',670),
  ('date_past -> NUMBER TIME PAST_PHRASE','date_past',3,'p_single_date_past','__init__.py',684),
  ('date_past -> WORD_NUMBER TIME PAST_PHRASE','date_past',3,'p_single_date_past','__init__.py',685),
  ('date_yesterday -> YESTERDAY','date_yesterday',1,'p_single_date_yesterday','__init__.py',693),
  ('date_yesterday -> YESTERDAY AT NUMBER','date_yesterday',3,'p_single_date_yesterday','__init__.py',694),
  ('date_yesterday -> YESTERDAY AT WORD_NUMBER','date_yesterday',3,'p_single_date_yesterday','__init__.py',695),
  ('date_2moro -> TOMORROW','date_2moro',1,'p_single_date_2moro','__init__.py',712),
  ('date_2moro -> TOMORROW AT NUMBER','date_2moro',3,'p_single_date_2moro','__init__.py',713),
  ('date_2moro -> TOMORROW AT WORD_NUMBER','date_2moro',3,'p_single_date_2moro','__init__.py',714),
  ...
  ('date_day -> PAST_PHRASE DAY','date_day',2,'p_single_date_day','__init__.py',734),
  ('date_or -> PAST_PHRASE TIME','date_or',2,'p_this_or_next_period','__init__.py',765),
  ('date_before_yesterday -> BEFORE_YESTERDAY','date_before_yesterday',1,'p_before_yesterday','__init__.py',786),
  ('date_before_yesterday -> THE BEFORE_YESTERDAY','date_before_yesterday',2,'p_before_yesterday','__init__.py',787),
  ('date_before_yesterday -> THE TIME BEFORE_YESTERDAY','date_before_yesterday',3,'p_before_yesterday','__init__.py',788),
  ('date_after_tomorrow -> AFTER_TOMORROW','date_after_tomorrow',1,'p_after_tomorrow','__init__.py',798),
  ('date_after_tomorrow -> THE TIME AFTER_TOMORROW','date_after_tomorrow',3,'p_after_tomorrow','__init__.py',799),
  ('date_end -> NUMBER DATE_END','date_end',2,'p_single_date_end','__init__.py',809),
  ('date_end -> THE NUMBER DATE_END','date_end',3,'p_single_date_end','__init__.py',810),
  ('date_end -> MONTH NUMBER DATE_END','date_end',3,'p_single_date_end','__init__.py',811),
  ('date_end -> NUMBER DATE_END OF MONTH','date_end',4,'p_single_date_end','__init__.py',812),
  ('date_end -> ON THE NUMBER DATE_END','date_end',4,'p_single_date_end','__init__.py',813),
  ('date_end -> MONTH THE NUMBER DATE_END','date_end',4,'p_single_date_end','__init__.py',814),
  ('date_end -> THE NUMBER DATE_END OF MONTH','date_end',5,'p_single_date_end','__init__.py',815),
]
